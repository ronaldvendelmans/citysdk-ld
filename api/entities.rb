  ...
  module Entities
    ...
    class API < Grape::API
      ...
      namespace :entities do
        desc "Expose a tool", params: CitySDK_LD::Entities::Tool.documentation
        get ':id' do
          present OpenStruct.new(id: params[:id], length: 10, weight: "20kg"), with: CitySDK_LD::Entities::Tool, foo: params[:foo]
        end
      end
    end
  end
